...
% \cite{batty2019map}  - link model - real system "A map is not the territory, or is it?"
% (inspire houllebeq et Levy) (meaning of representation)


% in practice for cities: real-time gis data % - real-time GIS data
...
% \cite{batty2021multiple} multiple models

% - urban analytics -policy \cite{kandt2021smart}
