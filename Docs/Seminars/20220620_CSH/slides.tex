...
\cite{gibrat1931inegalits} 
\cite{eeckhout2004gibrat} % comprehensive review - framing

Empirical investigations confirm Gibrat's law holds \cite{ioannides2003zipf}


Produces a log-normal size distribution (not a Pareto one - Zipf's law): extended model with new entrant cities yields Zipf \cite{gabaix1999zipf}; other model with heterogenous variances \cite{cordoba2008generalized}


Issues of city definition for estimation \cite{berry2012city} (as for scaling laws \cite{cottineau2017diverse})

}

\sframe{Simon preferential attachment}{
...
\sframe{Models benchmarking and validation: towards multi-modeling?}{

More elaborated extensions, including urban interactions: 
